...
function Calculator() {
  ...
  this.calculate = function (str) {
    ...
    if (!this.methods[operator] || isNaN(a) || isNaN(b)) {
      return Error('Не существует такого оператора или операнды не являются числом!')
    }
...
console.log('3 + 7 = ' + calc.calculate('3 + 7'))
...
console.log('12 / 4 = ' + powerCalc.calculate('12 / 4'))
console.log('2 * 3 = ' + powerCalc.calculate('2 * 3'))
